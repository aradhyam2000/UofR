...
Also, we can observe that sd is decreases as n increases which means increase in
accuracy. Also theoretical mean was 0.50 which is almost equal to mean we got
from 3 histograms. 
For n=1000, we observed bimodal histogram.
